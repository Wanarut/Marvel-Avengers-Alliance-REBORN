...
namespace Marvel_Avengers_Alliance_REBORN.States
{
    class SelectState : MAAGame
    {
        ...
        public SelectState(/*List<Character> avatar*/)
        {
            ...
            MonHeros.Add(new Ant_Man(Content));
            MonHeros.Add(new Deadpool(Content));
            MonHeros.Add(new Captain_America(Content));
        ...
        public SelectState(MAAGame game, GraphicsDeviceManager graphicsDevice, ContentManager content, List<Character> enemies)
        {
            _game = game;
        ...
        protected override void LoadContent()
        {
            ...
            #region Song
            song = Content.Load<Song>("Songs/" + Songs.SelectSong);    //Set Song
            ...
            #region Back,Start
            var btnBack = new SelectIcon(Content, IconHeros.Button_Back);
            btnBack.Position = new Vector2(10,10);
            btnBack.Click += Back_was_Clicked;
            Button.Add(btnBack);

            var btnStart = new SelectIcon(Content, IconHeros.Button_Start);
            ...
            #region CreatCrad
            var btnCard = new SelectCard(Content, IconHeros.Deadpool_Card);
            ...
            btnCard = new SelectCard(Content, IconHeros.AntMan_Card);
            btnCard.Position = new Vector2((Select_background.Get_Width() / 2 - (btnCard.Get_Width() / 2)), 50);
            cards.Add(btnCard);
            btnCard.Click += Card_was_Clicked;

            btnCard = new SelectCard(Content, IconHeros.Hulk_Card);
            btnCard.Position = new Vector2(((Select_background.Get_Width() / 2 - (btnCard.Get_Width() / 2)) + btnCard.Get_Width() + 10), 50);
            cards.Add(btnCard);
            btnCard.Click += Card_was_Clicked;

            btnCard = new SelectCard(Content, IconHeros.Captain_Card);
            ...
            heroes[0]._hp_bar = new StatusBar(heroes[0].Get_Name(), heroes[0].Get_Max_Health(), Gadget.HEALTH, Content);
            ...
            heroes[1]._hp_bar = new StatusBar(heroes[1].Get_Name(), heroes[1].Get_Max_Health(), Gadget.HEALTH, Content);
            ...
            heroes[2]._hp_bar = new StatusBar(heroes[2].Get_Name(), heroes[2].Get_Max_Health(), Gadget.HEALTH, Content);
            heroes[2]._hp_bar.Position = new Vector2(10, 240);

            var btnIconAntMan1 = new SelectIcon(Content, IconHeros.AntMan_Icon_Mon);
            btnIconAntMan1.Position = new Vector2(Xposition[3], Yposition[3]);
            HeroSelect.Add(btnIconAntMan1);
            heroes.Add(new Ant_Man(Content));
            heroes[3]._hp_bar = new StatusBar(heroes[3].Get_Name(), heroes[3].Get_Max_Health(), Gadget.HEALTH, Content);
            heroes[3]._hp_bar.Position = new Vector2(10, 260);

            var btnIconAntMan2 = new SelectIcon(Content, IconHeros.AntMan_Icon_Mon);
            btnIconAntMan2.Position = new Vector2(Xposition[4], Yposition[4]);
            HeroSelect.Add(btnIconAntMan2);
            heroes.Add(new Ant_Man(Content));
            heroes[4]._hp_bar = new StatusBar(heroes[4].Get_Name(), heroes[4].Get_Max_Health(), Gadget.HEALTH, Content);
            heroes[4]._hp_bar.Position = new Vector2(10, 280);

            var btnIconAntMan3 = new SelectIcon(Content, IconHeros.AntMan_Icon_Mon);
            btnIconAntMan3.Position = new Vector2(Xposition[5], Yposition[5]);
            HeroSelect.Add(btnIconAntMan3);
            heroes.Add(new Ant_Man(Content));
            heroes[5]._hp_bar = new StatusBar(heroes[5].Get_Name(), heroes[5].Get_Max_Health(), Gadget.HEALTH, Content);
            ...
            {
                var btnIconDeadpoolmon = new SelectIcon(Content, IconHeros.Deadpool_Icon_Mon);
            ...
            {
                var btnIconAntManmon = new SelectIcon(Content, IconHeros.AntMan_Icon_Mon);
            ...
            {
                var btnIconHulkmon = new SelectIcon(Content, IconHeros.Hulk_Icon_Mon);
            ...
            {
                var btnIconCaptainmon = new SelectIcon(Content, IconHeros.Captain_Icon_Mon);
            ...
            {
                var btnIconX23mon = new SelectIcon(Content, IconHeros.X23_Icon_Mon);
            ...
            //{
            //    var btnIconCablemon = new SelectIcon(Content, IconHeros.Cable_Icon_Mon);
            ...
            //    HeroSelect[5] = btnIconCablemon;
            //    btnIconCablemon.Click += Icon_was_Clicked;
            //    heroes[3]._hp_bar = new StatusBar(heroes[4].Get_Name(), heroes[4].Get_Max_Health(), Gadget.HEALTH, Content);
            //    heroes[3]._hp_bar.Position = new Vector2(10, 300);
            //}
            //Mon3
        ...
        private void Start_was_Clicked(object sender, EventArgs e)
        {
            ...
            {
                heroes[0] = new Deadpool(Content);
                heroes[0]._hp_bar = new StatusBar(heroes[0].Get_Name(), heroes[0].Get_Max_Health(), Gadget.HEALTH, Content);
                heroes[0]._hp_bar.Position = new Vector2(10, 200);
            }
            else if (HeroSelect[0].Get_Name() == "Ant-Man_Icon")
            {
                heroes[0] = new Ant_Man(Content);
                heroes[0]._hp_bar = new StatusBar(heroes[0].Get_Name(), heroes[0].Get_Max_Health(), Gadget.HEALTH, Content);
                heroes[0]._hp_bar.Position = new Vector2(10, 200);
            ...
            {
                heroes[0] = new Captain_America(Content);
                heroes[0]._hp_bar = new StatusBar(heroes[0].Get_Name(), heroes[0].Get_Max_Health(), Gadget.HEALTH, Content);
                heroes[0]._hp_bar.Position = new Vector2(10, 200);
            ...
            {
                heroes[1] = new Deadpool(Content);
                heroes[1]._hp_bar = new StatusBar(heroes[1].Get_Name(), heroes[1].Get_Max_Health(), Gadget.HEALTH, Content);
                heroes[1]._hp_bar.Position = new Vector2(10, 220);
            }
            else if (HeroSelect[1].Get_Name() == "Ant-Man_Icon")
            {
                heroes[1] = new Ant_Man(Content);
                heroes[1]._hp_bar = new StatusBar(heroes[1].Get_Name(), heroes[1].Get_Max_Health(), Gadget.HEALTH, Content);
                heroes[1]._hp_bar.Position = new Vector2(10, 220);
            ...
            {
                heroes[1] = new Captain_America(Content);
                heroes[1]._hp_bar = new StatusBar(heroes[1].Get_Name(), heroes[1].Get_Max_Health(), Gadget.HEALTH, Content);
                heroes[1]._hp_bar.Position = new Vector2(10, 220);
            ...
            {
                heroes[2] = new Deadpool(Content);
                heroes[2]._hp_bar = new StatusBar(heroes[2].Get_Name(), heroes[2].Get_Max_Health(), Gadget.HEALTH, Content);
                heroes[2]._hp_bar.Position = new Vector2(10, 240);
            }
            else if (HeroSelect[2].Get_Name() == "Ant-Man_Icon")
            {
                heroes[2] = new Ant_Man(Content);
                heroes[2]._hp_bar = new StatusBar(heroes[2].Get_Name(), heroes[2].Get_Max_Health(), Gadget.HEALTH, Content);
                heroes[2]._hp_bar.Position = new Vector2(10, 240);
            ...
            {
                heroes[2] = new Captain_America(Content);
                heroes[2]._hp_bar = new StatusBar(heroes[2].Get_Name(), heroes[2].Get_Max_Health(), Gadget.HEALTH, Content);
                heroes[2]._hp_bar.Position = new Vector2(10, 240);
        ...
        private void Icon_was_Clicked(object sender, EventArgs e)
        {
            if (((SelectIcon)sender).Get_Name() == HeroSelect[0].Get_Name())
            {
                ...
                {
                    var CableStatus = new SelectIcon(Content, IconHeros.Cable_Status);
                ...
                case IconHeros.Cable_Card:
                    {
                        if (numSelect % 3 == 0)
                        {
                            var btnIconCable = new SelectIcon(Content, IconHeros.Cable_Icon);
